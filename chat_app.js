document.addEventListener('DOMContentLoaded', () => {
    ...
    const replies = {
        ...
        foodStraight: "Going straight from Gate 1, you'll find more food stalls along the path.",
        foodStudent: "Some food stalls are near the student section at the end of D.",
        ...
        bioToilet: "Biotoilets are located in the student section at the end of D.",
        allToilets: "Toilets are near C & D, and biotoilets at the student section.",
        student: "The student section is at the end of D; it has most of the engineering exhibits and crowds.",
        ...
        routeAud: "From Gate 1, go straight to reach the auditorium. On the left is Office F and nearby flag.",
        routeABCD: "Blocks A & B are to the right from Gate 1; behind them are C & D.",
        routeGH: "Blocks G & H are to the left from Office F after Gate 1.",
        crowdStudent: "The student section is usually crowded; visit early if you want more space.",
        crowdFood: "Food stall areas are moderately crowded, especially near A & B.",
        allStalls: "All stalls are spread around the blocks; food near A-B and Gate 1, shopping in G-H, student exhibits at D.",
        chooseBlock: "Which block do you want to see stalls from? A, B, C, D, G, or H?",
        "metal-steel": "Produces high-quality steel and metal components for defense and industry.",
        ...
        "india-optel": "Optical and electronics solutions for defense applications.",
        "aweil": "Advanced Weapons and Equipment India Limited, specializing in cutting-edge weapons.",
        "indian-air-force": "Indian Air Force exhibit showcasing aircraft and technologies.",
        ...
        "gliders-india": "Gliders India Limited: aviation and glider technology.",
        ...
        "dept-agri-wb": "The Department of Agriculture, West Bengal, improves agricultural productivity and ensures food security through modern farming, soil health, and sustainable practices.",
        "directorate-ext": "The Directorate of Extension, GOI, bridges agricultural research and farmers, promoting capacity-building programs and field demonstrations.",
        ...
        "icar-icar-kolkata": "ICAR-ATR, Kolkata, specializes in agricultural mechanization, climate-smart farming, and technology dissemination to farmers across eastern India.",
        ...
        "wb-ngrba": "The West Bengal NGRBA Program Management Group manages river basins, pollution control, and ecosystem restoration.",
        ...
        "tripura-tourism": "Tripura Tourism promotes cultural heritage, landscapes, tribal traditions, wildlife sanctuaries, and eco-tourism.",
        "eastern-railway": "Eastern Railway ensures passenger and freight services, rail connectivity, and regional economic support.",
        "adamas-univ": "Adamas University offers multidisciplinary higher education, research, and innovation programs.",
        ...
        "sister-nivedita-univ": "Sister Nivedita University offers programs in science, engineering, law, humanities, and media studies, emphasizing research and innovation.",

        // Block D / Science & Research
        "bose-institute": "Bose Institute conducts interdisciplinary scientific research in physics, chemistry, biology, and environmental sciences.",
        "iiser-kolkata": "IISER Kolkata provides high-quality science education and research in biology, physics, chemistry, mathematics, and earth sciences.",
        "saha-institute": "The Saha Institute of Nuclear Physics focuses on theoretical and experimental nuclear physics, particle physics, and biophysical sciences.",
        ...
        "bric-dna": "BRIC-Centre for DNA Fingerprinting & Diagnostics provides DNA-based diagnostics, genetic fingerprinting, and biotechnology research.",
        "bric-dbt": "BRIC, DBT advances biotechnological innovations, collaborations, and research in healthcare, agriculture, and industrial biotech.",
        ...
        "science-model": "The Science Model Competition showcases creative scientific models, prototypes, and student research projects.",
        ...
        "survey-india": "The Survey of India manages cartographic data, topographical surveys, geospatial information, and infrastructure for defense and governance.",
        "anusandhan-nrf": "The Anusandhan National Research Foundation promotes research across science, technology, social sciences, and humanities.",

        // Block G / Textile & Handicrafts
        "national-jute-board": "The National Jute Board promotes, develops, and expands the jute sector, supporting eco-friendly alternatives and artisan livelihoods.",
        "blooming-rose": "Blooming Rose specializes in innovative and sustainable jute products for local and national markets.",
        "jute-baggy": "Jute Baggy Enterprise produces handmade jute bags and accessories, blending traditional craftsmanship with modern designs.",
        "victor-jute": "Victor Jute Products creates jute crafts, bags, and home items, promoting eco-conscious living.",
        "tania-sarkar": "Tania Sarkar specializes in jute handicrafts, combining traditional weaving with contemporary aesthetics.",
        "jute-hind": "Jute Hind focuses on eco-friendly jute bags and lifestyle products, preserving Kolkata’s heritage of jute craftsmanship.",
        "umita-jute": "Umita Jute Centre supports rural artisans in weaving and crafting jute-based items, preserving traditional methods.",
        ...
        "icmr-nirbi": "ICMR-NIRBI conducts advanced biological and immunological research, contributing to vaccine development and diagnostics.",
        "nhm-wb": "The National Health Mission in West Bengal strengthens health infrastructure, maternal-child health, and affordable healthcare.",
        "univ-burdwan": "The University of Burdwan engages in higher education and research, focusing on medical sciences, public health, and applied life sciences."
    };
    ...
    const subOptions = {
        ...
        stall: [
            { text: 'Choose Block', key: 'chooseBlock' }
        ]
    };
    ...
    const blocks = {
        A: [
            { key: 'metal-steel', name: "Metal & Steel Factory, Ishapore, GOI" },
            { key: 'armoured', name: "Armoured Vehicles Nigam Limited, GOI" },
            { key: 'drdo', name: "Defence Research & Development Organisation, GOI" },
            ...
            { key: 'aweil', name: "Advanced Weapons and Equipment India Limited, GOI" },
            ...
            { key: 'mazagon-doc', name: "Mazagon Dock Shipbuilders Limited, GOI" }
        ],
        B: [
            { key: 'cmfri', name: "ICAR - Central Marine Fisheries Research Institute, Kochi" },
            { key: 'dept-agri-wb', name: "Department of Agriculture, Govt. of West Bengal" },
            { key: 'directorate-ext', name: "Directorate of Extension, GOI" },
            { key: 'nbfgr', name: "ICAR - National Bureau of Fish Genetics Resources, GOI" },
            { key: 'icar-icar-kolkata', name: "ICAR Application Technology Research Institute, Kolkata" },
            { key: 'cife', name: "ICAR - Central Institute of Fisheries Education, GOI" },
            { key: 'dkma', name: "ICAR - Directorate of Knowledge Management in Agriculture, GOI" },
            { key: 'apeda', name: "Agricultural and Processed Food Products Export Development Authority, GOI" }
        ],
        C: [
            { key: 'ntpc', name: "NTPC Limited, GOI" },
            { key: 'gsi', name: "Geological Survey of India, GOI" },
            { key: 'wb-ngrba', name: "West Bengal NGRBA Program Management Group" },
            { key: 'neepcl', name: "North Eastern Electric Power Corporation Limited, GOI" },
        ...
        D: [
            { key: 'bose-institute', name: "Bose Institute, Department of Science and Technology, GOI" },
            { key: 'iiser-kolkata', name: "Indian Institute of Science Education and Research, Kolkata, GOI" },
            { key: 'saha-institute', name: "Saha Institute of Nuclear Physics, Department of Atomic Energy, GOI" },
            { key: 'dae', name: "Department of Atomic Energy, GOI" },
            { key: 'bric-dna', name: "Bric-Centre for DNA Fingerprinting & Diagnostics, GOI" },
            ...
            { key: 'csir', name: "Council of Scientific and Industrial Research, GOI" },
            { key: 'moes', name: "Ministry of Earth Sciences, GOI" },
            { key: 'survey-india', name: "Survey of India, GOI" },
            { key: 'anusandhan-nrf', name: "Anusandhan National Research Foundation" }
        ],
        G: [
            ...
            { key: 'victor-jute', name: "VICTOR JUTE PRODUCTS, North 24 Parganas" },
        ...
        H: [
            ...
            { key: 'nhm-wb', name: "National Health Mission, Govt. of West Bengal" },
    ...
    function showStalls(blockKey) {
        ...
        const options = blocks[blockKey].map(s => ({ text: s.name, key: s.key }));
        showOptions(options);
    }
    ...
    function handleOption(key) {
        ...
        if (key === 'chooseBlock') {
            addMessage("Which block do you want to see stalls from? A, B, C, D, G, or H?");
            showOptions([
                { text: 'Block A', key: 'A' },
                { text: 'Block B', key: 'B' },
                { text: 'Block C', key: 'C' },
        ...
        if (['A','B','C','D','G','H'].includes(key)) {
            addMessage(`Here are the stalls in Block ${key}:`);
            showStalls(key);
            return;
        }

        // Specific stall selected
        const allStalls = Object.values(blocks).flatMap(b => b.map(s => s.key));
        if (allStalls.includes(key)) {
            const stall = Object.values(blocks).flatMap(b => b).find(s => s.key === key);
            addMessage(`${stall.name}: ${replies[key] || 'Description not available.'}`);
            return;
        }
        ...
        // Replies for main/sub-options
        if(key === 'feedback') {
            window.open('https://docs.google.com/forms/d/e/1FAIpQLSdD_It5dDtkF5lAka3NvqVQP_fDnd9cik3RnfqcRnPNX5iVqA/viewform?usp=header', '_blank');
            addMessage("Opening the feedback form in a new tab...");
        } else {
            addMessage(replies[key] || "Please choose an option.");
    ...
    // Initialize chatbot
    // ==========================
    addMessage("Hello! How can I assist you at the exhibition today?");
